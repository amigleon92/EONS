                            ...
                            switch(algoritmoSeleccionado){ // vemos cual algoritmo ha sido selecciondo, y realizamos la ejecucion de cada uno
                                ...
                                case "MPSC":
                                    ...
                                    if(r!=null){
                                        ...
                                        Utilitarios.asignarFS(ksp,r,G[a],d,++conexid[a]);
                                    }  
                                    else{
                                        contB[a]++;
                                    }
                                ...
                                case "FAR - FF - SP - DF":
                                    ...
                                    if (defrag==true) {
                                        ...
                                        for(int kk=0;kk<connection1.size();kk++){
                                            ...
                                            if(r!=null){
                                                Utilitarios.asignarFS(kspdf,r,G[a],df,++did);
                                 ...
                                 switch(algoritmo){ // vemos cual algoritmo ha sido selecciondo, y realizamos la ejecucion de cada uno
                                    ...
                                    //
                                     case "FAR - FF - SP - DF":
                                         ...
                                         if(r!=null){
                                             Utilitarios.asignarFS(ksp,r,G[1],d,++conexid[idf]);
                                             connection1.add(d);
                                         ...
                                         if (defrag==true) {
                                             ...
                                             for(int kk=0;kk<connection1.size();kk++){
                                                 ...
                                                 if(r!=null){
                                                     Utilitarios.asignarFS(kspdf,r,G[1],df,++did);
